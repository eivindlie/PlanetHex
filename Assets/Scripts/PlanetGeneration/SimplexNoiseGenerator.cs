...
public class SimplexNoiseGenerator
{
    ...
    public int getDensity(Vector3 loc, int min, int max, int octaves = 1, int multiplier = 25, float amplitude = 0.5f, float lacunarity = 2, float persistence = 0.9f)
    {
        float val = Mathf.Abs(coherentNoise(loc.x, loc.y, loc.z, octaves, multiplier, amplitude, lacunarity, persistence));
